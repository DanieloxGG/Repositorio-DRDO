...
while juego==1:
    ...
    while elegir==1:
        ...
        print("")
        if numjug > 21:
            print(f"Tienes un {numjug}, te has pasado de 21. Has perdido. (-2 dinero)")
            print("")
            elegir=0
            juego=0
    ...
    while elegcrup == 1:
        ...
        if numcrupier > 17 and numcrupier < 22:
            print(f"El crupier se ha plantado con un {numcrupier}")
            print("")
            elegcrup=0
            if numcrupier < numjug:
                print(f"Has sacado un {numjug} y el crupier un {numcrupier}")
                print("Has ganado. (+4 monedas)")
                print("")
                dinero=dinero+4
            else:
                print(f"Has sacado un {numjug} y el crupier un {numcrupier}")
                print("Has perdido. (-2 monedas)")
                print("")
        elif numcrupier > 21:
            print(f"El crupier tiene un {numcrupier}, se ha pasado de 21. Has ganado. (+4 monedas)")
            elegcrup=0
            dinero=dinero+4
        else:
